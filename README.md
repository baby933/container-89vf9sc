...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-89vf9sc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-89vf9sc.containers.anotherwebservice.com/
...
```
git clone git@github.com:baby933/container-89vf9sc.git
cd container-89vf9sc
```
...
```
docker attach container-89vf9sc
```
